...
const Footer = () => {
  return (
    <div >
      <footer style={{ backgroundImage: `url(${footer})` }} class="footer p-10 bg-base-200 text-base-content">
        <div>
      ...
      <footer class="footer px-10 py-4 border-t text-base-content border-base-300 bg-blue-200">
        <div class="items-center grid-flow-col">
          ...
          <p>Parts of Car Ltd. <br />Providing reliable tech since 1992</p>
        </div>
